/**
 * Simulation page — gds-sim results: population charts per parameter subset.
 * Includes play/pause animation to scrub through generations.
 */
...
function renderSim(data) {
  ...
  container.innerHTML = `
    ...
    <section class="sim-section">
      ...
      <p class="sim-desc">Each chart shows how strategy populations evolve under different parameter settings. Press Play to animate through generations.</p>
...
function renderLegend(names) {
  document.getElementById('sim-legend').innerHTML = names.map(name =>
...
function drawChart(s) {
  ...
  // Stacked area up to current frame
